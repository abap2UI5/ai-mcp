...
export function resolveSamples() {
  return resolveRepo(envOf('samples'), siblingsOf('samples'), probeOf('samples'));
}
...
export function resolveSamplesStack() {
  return resolveRepo(envOf('samplesStack'), siblingsOf('samplesStack'), probeOf('samplesStack'));
}
...
export function resolveViewCheck() {
  return resolveRepo(envOf('viewCheck'), siblingsOf('viewCheck'), probeOf('viewCheck'));
}
